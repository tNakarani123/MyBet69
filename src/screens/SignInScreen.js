        ...
        <ImageBackground style={{ flex: 1 }} source={require('../assets/images/background.png')}>
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{ height: Height(465), backgroundColor: 'white', marginTop: Height(62), borderTopLeftRadius: Width(20), borderTopRightRadius: Width(20) }}>
                    ...
                    <Text style={{ fontSize: Height(20), fontFamily: 'Poppins-Regular', textAlign: 'center', marginTop: Height(15), color: 'black' }}>Get You Login</Text>
                    ...
                    <Text style={{ fontSize: Height(20), fontFamily: 'Poppins-Regular', marginTop: Height(30), marginLeft: Width(20), color: '#5556CA' }} onPress={() => navigation.navigate('SignUp')}>Registration</Text>
                </View>
            </SafeAreaView>
        </ImageBackground>
    )
