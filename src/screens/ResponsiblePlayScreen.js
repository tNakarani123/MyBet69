            ...
            <SafeAreaView style={{ flex: 1 }}>
                <DropShadow style={{
                    ...
                    <View style={{ height: Height(90), borderBottomLeftRadius: Width(20), borderBottomRightRadius: Width(20), paddingHorizontal: Width(25), backgroundColor: 'white' }}>
                        ...
                        <Text style={{ textAlign: 'center', fontSize: Height(16), fontFamily: 'Poppins-Bold', marginTop: Height(10) }}>Responsible Play</Text>
                    </View>
                </DropShadow>
...
export default ResponsiblePlayScreen
